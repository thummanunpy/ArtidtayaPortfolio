...
<template>
	<div class="container mx-auto ">
		<div
			class="pt-20 sm:pt-30 mt-20 border-t-2 border-primary-light dark:border-secondary-dark"
		>
			<!-- Footer social links -->
			<div
			...
			>
				...
				<ul class="flex gap-4 sm:gap-8">
					<a
						...
						:href="social.url"
						target="__blank"
						class="text-gray-400 hover:text-rose-700 cursor-pointer rounded-lg bg-gray-50 dark:bg-ternary-dark hover:bg-gray-100 shadow-sm p-4 duration-500"
					>
						<i
